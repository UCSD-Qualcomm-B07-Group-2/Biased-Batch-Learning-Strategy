...
class AdvancedGCNRegression(torch.nn.Module):
    def __init__(self, num_node_features, conv1_out_features=16, conv2_out_features=32, conv3_out_features=32, gat_out_features=32, gat_heads=4, dropout_rate=0.01):
